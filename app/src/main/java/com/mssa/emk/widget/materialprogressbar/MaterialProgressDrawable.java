...
package com.mssa.emk.widget.materialprogressbar;
...
public class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    /**
     * Update the background color of the circle_payment image view.
     */
        ...
        final Animation animation = new Animation() {
            ...
            public void applyTransformation(float interpolatedTime, Transformation t) {
                if (mFinishing) {
                    ...
                    //Avoid the ring to be a full circle_payment
    ...
    private static class Ring {
        ...
        // progress circle_payment should currently display. As the progress circle_payment is
        ...
        /**
         * @param centerRadius Inner radius in px of the circle_payment the progress
         *                     spinner arc traces.
         */
