package com.mssa.emk.activities.familyHistoryActivity;
...
import com.mssa.emk.activities.questionNodeActivity.QuestionsAdapter;
...
import com.mssa.emk.utilities.pageindicator.ScrollingPagerIndicator;
...
//        if (sessionManager.getLicenseKey() != null && !sessionManager.getLicenseKey().isEmpty())
    ...
    public boolean insertDb(String value) {
        ...
        obsDTO.setValue(com.mssa.emk.utilities.StringUtils.getValue(value));
